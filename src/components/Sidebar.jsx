...
export default function Sidebar({ tab, setTab, user, onLogout }) {
  return (
    <aside style={{ width:216, flexShrink:0, background:'rgba(0,0,0,0.85)', borderRight:'1px solid rgba(0,255,136,0.07)', display:'flex', flexDirection:'column', padding:'24px 12px', height:'100vh', position:'sticky', top:0, overflow:'hidden' }}>
      {/* Logo */}
      ...
      <div style={{ marginTop:'auto', paddingTop:12 }}>
        ...
        <button onClick={() => { clearActiveUser(); onLogout() }}
          style={{ width:'100%', padding:'9px 12px', background:'transparent', border:'1px solid rgba(255,107,107,0.15)', borderRadius:6, color:'#444', fontFamily:'monospace', fontSize:9, letterSpacing:2, cursor:'pointer', textTransform:'uppercase', transition:'all 0.2s' }}
