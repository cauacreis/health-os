        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div style={{ minWidth: 0 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
              ...
              {user.isPro && (
                <span style={{ fontSize: 8, letterSpacing: 1, color: '#dc2626', border: '1px solid rgba(220,38,38,0.4)', padding: '1px 5px', borderRadius: 2, flexShrink: 0 }}>PRO</span>
              )}
            </div>            <div style={{ color: '#444', fontSize: 9, marginTop: 1 }}>{user.weight}kg · {user.height}cm</div>
          </div>
        </div>
      </div>
